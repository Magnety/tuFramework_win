...
import numpy as np
from tuframework.network_architecture.cotr import CNNBackbone
from tuframework.network_architecture.neural_network import SegmentationNetwork
from tuframework.network_architecture.cotr.DeTrans.DeformableTrans import DeformableTransformer
from tuframework.network_architecture.cotr.DeTrans.position_encoding import build_position_encoding
...
class ResTranUnet(SegmentationNetwork):
    ...
    ResTran-3D Unet
    """
    def __init__(self,  img_size=None, num_classes=None, weight_std=False, deep_supervision=False):
        super().__init__()
        self.do_ds = False
        norm_cfg = 'BN'
        activation_cfg = 'ReLU'
