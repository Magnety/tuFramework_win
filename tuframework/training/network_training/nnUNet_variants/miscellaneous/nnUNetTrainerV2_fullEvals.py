...
class nnUNetTrainerV2_fullEvals(nnUNetTrainerV2):
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        """
        disable tuframework postprocessing. this would just waste computation time and does not benefit brats
    ...
    def on_epoch_end(self):
        ...
        if (self.epoch + 1) % self.validate_every == 0:
            ...
            fully_trained_tuframework = (0.911, 0.8739, 0.7848)
            mean_dice = np.mean(fully_trained_tuframework)
