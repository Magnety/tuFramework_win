...
from tuframework.training.loss_functions.dice_loss import SoftDiceLoss
from tuframework.utilities.nd_softmax import softmax_helper


class tuframeworkTrainerV2_Loss_Dice(tuframeworkTrainerV2):
...
class tuframeworkTrainerV2_Loss_DicewithBG(tuframeworkTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
