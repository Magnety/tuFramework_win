...
from tuframework.paths import tuFramework_raw_data, tuFramework_cropped_data
import numpy as np
import pickle
from tuframework.preprocessing.cropping import get_patient_identifiers_from_cropped_files
