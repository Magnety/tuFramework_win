...
from tuframework.experiment_planning.utils import split_4d, crop, analyze_dataset, plan_and_preprocess
...
if __name__ == "__main__":
    ...
    if task == "all":
        all_tasks = subdirs(tuFramework_raw_data, prefix="Task", join=False)
        for t in all_tasks:
