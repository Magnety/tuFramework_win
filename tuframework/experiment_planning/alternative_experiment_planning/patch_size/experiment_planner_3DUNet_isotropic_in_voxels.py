...
class ExperimentPlanner3D_IsoPatchesInVoxels(ExperimentPlanner):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "tuframeworkData_isoPatchesInVoxels"
        self.plans_fname = join(self.preprocessed_output_folder, "tuframeworkPlans" + "fixedisoPatchesInVoxels_plans_3D.pkl")
