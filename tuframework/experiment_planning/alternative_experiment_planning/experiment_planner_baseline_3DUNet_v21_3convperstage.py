...
from tuframework.experiment_planning.experiment_planner_baseline_3DUNet_v21 import ExperimentPlanner3D_v21
...
class ExperimentPlanner3D_v21_3cps(ExperimentPlanner3D_v21):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = self.preprocessed_output_folder+"/"+"tuframeworkPlansv2.1_3cps_plans_3D.pkl"
