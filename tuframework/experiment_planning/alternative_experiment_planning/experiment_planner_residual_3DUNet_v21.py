...
import numpy as np
from tuframework.experiment_planning.experiment_planner_baseline_3DUNet_v21 import \
...
from tuframework.network_architecture.generic_modular_residual_UNet import FabiansUNet
...
class ExperimentPlanner3DFabiansResUNet_v21(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.data_identifier = "tuData_plans_v2.1"# "tuframeworkData_FabiansResUNet_v2.1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "tuPlans_FabiansResUNet_v2.1_plans_3D.pkl")
