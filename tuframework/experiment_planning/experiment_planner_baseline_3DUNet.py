...
from tuframework.experiment_planning.common_utils import get_pool_and_conv_props_poolLateV2
from tuframework.experiment_planning.utils import create_lists_from_splitted_dataset
from tuframework.network_architecture.generic_UNet import Generic_UNet
from tuframework.paths import *
from tuframework.preprocessing.cropping import get_case_identifier_from_npz
...
if __name__ == "__main__":
    ...
    for i in task_ids:
        i = int(i)
        candidates = subdirs(tuFramework_cropped_data, prefix="Task%03.0d" % i, join=False)
