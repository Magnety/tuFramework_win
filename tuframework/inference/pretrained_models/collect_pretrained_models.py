...
import shutil
from tuframework.paths import default_cascade_trainer, default_plans_identifier, default_trainer, network_training_output_dir
...
def copy_pretrained_models_for_task(task_name: str, output_directory: str,
                                    ...
                                    tuframework_trainer=default_trainer,
                                    tuframework_trainer_cascade=default_cascade_trainer,
                                    plans_identifier=default_plans_identifier):
    trainer_output_dir = tuframework_trainer + "__" + plans_identifier
    trainer_output_dir_cascade = tuframework_trainer_cascade + "__" + plans_identifier
...
def export_pretrained_model(task_name: str, output_file: str,
    ...
    valid = []
    for s in subd:
        v = check_if_valid(s, models, (tuframework_trainer, tuframework_trainer_cascade), (plans_identifier))
        if v:
            valid.append(s)
    for v in valid:
...
def export_entry_point():
    ...
    parser.add_argument('-pl', type=str, help='tuframework plans identifier. Default: %s' % default_plans_identifier,
